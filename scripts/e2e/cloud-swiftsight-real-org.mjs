      ...
      issue: {
        ...
        description: [
          ...
          ...buildManagerHelperLines([
            ...
            `- QA review start: \`node ${PROTOCOL_HELPER_PATH} start-review --issue "$SQUADRAIL_TASK_ID" --sender-role reviewer --summary "TL starts SafeJoin code review" --review-focus "path traversal preserved||nested segments preserved||focused package test evidence"\``,
