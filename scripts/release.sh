...
pnpm --filter @squadrail/adapter-utils build
pnpm --filter @squadrail/db build
pnpm --filter @squadrail/adapter-claude-local build
pnpm --filter @squadrail/adapter-codex-local build
pnpm --filter @squadrail/adapter-openclaw build
