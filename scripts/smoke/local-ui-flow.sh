...
PROJECT_OVERVIEW_DOM_PATH="${PROJECT_OVERVIEW_DOM_PATH:-$SQUADRAIL_HOME/project-overview.dom.html}"
...
PROJECT_OVERVIEW_URL="${BASE_URL}/${COMPANY_PREFIX}/projects/${PROJECT_ID}/overview"
...
echo "==> verifying project overview page"
dump_dom_page "$PROJECT_OVERVIEW_URL" "$PROJECT_OVERVIEW_DOM_PATH"
grep -q "Current project delivery" "$PROJECT_OVERVIEW_DOM_PATH"
grep -q "Active roots" "$PROJECT_OVERVIEW_DOM_PATH"
grep -Eq "No active parent issues yet|Smoke protocol issue" "$PROJECT_OVERVIEW_DOM_PATH"
...
echo "    project overview: ${PROJECT_OVERVIEW_URL}"
...
echo "    project overview DOM: ${PROJECT_OVERVIEW_DOM_PATH}"
