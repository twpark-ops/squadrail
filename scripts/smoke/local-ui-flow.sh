...
grep -q "Squad Stage" "$TEAM_DOM_PATH"
grep -q "delivery floor" "$TEAM_DOM_PATH"
grep -q "Current focus" "$TEAM_DOM_PATH"
grep -q "Parent issue progress" "$TEAM_DOM_PATH"
grep -q "Office map" "$TEAM_DOM_PATH"
