...
import { PRODUCT_NAME, PRIMARY_CLI_COMMAND, squadrailDataDirHelpText } from "./utils/branding.js";

const program = new Command();
const DATA_DIR_OPTION_HELP = squadrailDataDirHelpText();
...
program
  ...
  .option("--filename-prefix <prefix>", "Backup filename prefix", "squadrail")
