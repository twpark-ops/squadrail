...
import type { SquadrailConfig } from "./schema.js";
...
export function ensureLocalSecretsKeyFile(
  config: Pick<SquadrailConfig, "secrets">,
  configPath?: string,
  ...
  const envMasterKey =
    process.env.SQUADRAIL_SECRETS_MASTER_KEY ?? process.env.SQUADRAIL_SECRETS_MASTER_KEY;
