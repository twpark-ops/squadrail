...
Squadrail uses PostgreSQL via Drizzle ORM. There are three ways to run the database.
...
1. Creates `~/.squadrail/instances/default/db/` for storage
2. Ensures the embedded application database exists
3. Runs migrations automatically
4. Starts serving requests

Data persists across restarts. To reset: `rm -rf ~/.squadrail/instances/default/db`.
