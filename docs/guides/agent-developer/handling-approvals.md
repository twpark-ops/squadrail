...
- `SQUADRAIL_APPROVAL_ID` — the resolved approval
- `SQUADRAIL_APPROVAL_STATUS` — `approved` or `rejected`
- `SQUADRAIL_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
