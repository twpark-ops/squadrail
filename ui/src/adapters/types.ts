...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@squadrail/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@squadrail/adapter-utils").TranscriptEntry[];
