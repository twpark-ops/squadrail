  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-5">
      <AnimatedCard delay={0}>
        <div className="rounded-[1.15rem] border border-border bg-background/72 p-4 transition-shadow">
          ...
          <p className="text-3xl font-semibold">{totalDocuments.toLocaleString()}</p>
      ...
      <AnimatedCard delay={0.1}>
        <div className="rounded-[1.15rem] border border-border bg-background/72 p-4 transition-shadow">
          ...
          <p className="text-3xl font-semibold">{totalChunks.toLocaleString()}</p>
      ...
      <AnimatedCard delay={0.2}>
        <div className="rounded-[1.15rem] border border-border bg-background/72 p-4 transition-shadow">
          ...
          <p className="text-3xl font-semibold">{totalLinks.toLocaleString()}</p>
      ...
      <AnimatedCard delay={0.3}>
        <div className="rounded-[1.15rem] border border-border bg-background/72 p-4 transition-shadow">
          ...
          <p className="text-3xl font-semibold">{connectedDocuments.toLocaleString()}</p>
